   ...
   return(
        <section>
            <header>
                ...
                <ProfileImage first_name={user.first_name} last_name={user.last_name} avatar={user.profile_picture_url ? profile_picture_url: DEFAULT_AVATAR} onClick={onAvatarClick}/>
            </header>
